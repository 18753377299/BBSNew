...
<!--       <a href="/myssm/user/find.do">我的信息</a> -->
    </c:otherwise>
  </c:choose>
  </p>
  <h1>BBS论坛</h1>
...
<!--       <h2>今日<span>话题</span></h2> -->
    ...
    <div class="content_text">
      ...
      <div class="wz">
        <h3><a href="#" title="浅谈：html5和html的区别">浅谈：html5和html的区别</a></h3>
        <dl>
          <dt><img src="images/s1.jpg" width="50" height="25" alt=""></dt>
          <dd>
            <p class="dd_text_1">最近看群里聊天聊得最火热的莫过于手机网站和html5这两个词。可能有人会问，这两者有什么关系呢？随着这移动互联
              网快速发展的时代，尤其是4G时代已经来临的时刻，加上微软对"XP系统"不提供更新补丁、维护的情况下。
              html5+css3也逐渐的成为新一代web前端技术.....</p>
      ...
      <br/>
      <div class="post">
      		<input type="text" id="idea" placeholder="你的看法" style="width:500px;height:30px;"/>
      ...
      <div class="">
      		...
      		<div>
      			...
      			<dl>
      				<dt><img src="#" >用户名</dt>
      				<dd><p>最近看群里聊天聊得最火热的莫过于手机网站和html5这两个词。可能有人会问，这两者有什么关系呢？随着这移动互联
             				 网快速发展的时代，尤其是4G时代已经来临的时刻，加上微软对</p>
                  	</dd>
